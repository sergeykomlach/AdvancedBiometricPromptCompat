...
public class SamsungFaceUnlockModule extends AbstractBiometricModule {
    private SemBioFaceManager manager = null;
    ...
    public SamsungFaceUnlockModule(BiometricInitListener listener) {
        ...
        if (listener != null) {
            listener
                    .initFinished(BiometricMethod.FACE_SAMSUNG, SamsungFaceUnlockModule.this);
        }
    }
    ...
    public boolean hasEnrolled() {
        if (manager != null) {
            try {
                return manager.isHardwareDetected() && manager.hasEnrolledFaces();
            } catch (Throwable e) {
                BiometricLoggerImpl.e(e);
            }
        }
    ...
    public void authenticate(final CancellationSignal cancellationSignal,
        ...
        for (BiometricMethod method : BiometricMethod.values()) {
            if (method.getId() == tag()) {
                BiometricLoggerImpl.d("SamsungFaceUnlockModule.authenticate - " + method.toString());
            }
        }
        ...
        if (manager != null) {
            try {
                ...
                final SemBioFaceManager.AuthenticationCallback callback =
                ...
                BiometricLoggerImpl.e(e, "SamsungFaceUnlockModule: authenticate failed unexpectedly");
            }
        }
    ...
    class AuthCallback extends SemBioFaceManager.AuthenticationCallback {
        ...
        public void onAuthenticationError(int errMsgId, CharSequence errString) {
            BiometricLoggerImpl.d("SamsungFaceUnlockModule.onAuthenticationError: " + CodeToString.getErrorCode(errMsgId) + "-" + errString);
            ...
            switch (errMsgId) {
                ...
                case BIOMETRIC_ERROR_USER_CANCELED:
                    Core.cancelAuthentication(SamsungFaceUnlockModule.this);
                    return;
        ...
        public void onAuthenticationHelp(int helpMsgId, CharSequence helpString) {
            BiometricLoggerImpl.d("SamsungFaceUnlockModule.onAuthenticationHelp: " + CodeToString.getHelpCode(helpMsgId) + "-" + helpString);
            if (listener != null) {
        ...
        @Override
        public void onAuthenticationSucceeded(SemBioFaceManager.AuthenticationResult result) {
            BiometricLoggerImpl.d("SamsungFaceUnlockModule.onAuthenticationSucceeded: " + result);
            if (listener != null) {
        ...
        public void onAuthenticationFailed() {
            BiometricLoggerImpl.d("SamsungFaceUnlockModule.onAuthenticationFailed: ");
            if (listener != null) {
