...
class AndroidFaceUnlockModule @SuppressLint("WrongConstant") constructor(listener: LegacyBiometricInitListener?) :
                ...
                FACE_ERROR_NEGATIVE_BUTTON, FACE_ERROR_USER_CANCELED -> {
                    if (!selfCanceled) {
                        listener?.onCanceled(
                            ...
                            errString ?: authenticationErrorWithCodeDescription(errMsgId)
                        )
