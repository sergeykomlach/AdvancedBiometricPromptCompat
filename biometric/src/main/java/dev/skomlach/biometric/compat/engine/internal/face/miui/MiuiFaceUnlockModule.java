...
public class MiuiFaceUnlockModule extends AbstractBiometricModule {
    ...
    public MiuiFaceUnlockModule(final BiometricInitListener listener) {
        ...
        if (listener != null) {
            listener
                    .initFinished(BiometricMethod.FACE_MIUI, MiuiFaceUnlockModule.this);
        }
    }
    ...
    public void authenticate(final CancellationSignal cancellationSignal,
        ...
        for (BiometricMethod method : BiometricMethod.values()) {
            if (method.getId() == tag()) {
                BiometricLoggerImpl.d("MiuiFaceUnlockModule.authenticate - " + method.toString());
            }
        }
        ...
        if (manager != null) {
            try {
                ...
                BiometricLoggerImpl.e(e, "MiuiFaceUnlockModule: authenticate failed unexpectedly");
            }
        }
    ...
    class AuthCallback extends IMiuiFaceManager.AuthenticationCallback {
        ...
        public void onAuthenticationError(int errMsgId, CharSequence errString) {
            BiometricLoggerImpl.d("MiuiFaceUnlockModule.onAuthenticationError: " + CodeToString.getErrorCode(errMsgId) + "-" + errString);
        ...
        public void onAuthenticationHelp(int helpMsgId, CharSequence helpString) {
            BiometricLoggerImpl.d("MiuiFaceUnlockModule.onAuthenticationHelp: " + CodeToString.getHelpCode(helpMsgId) + "-" + helpString);
            if (listener != null) {
        ...
        public void onAuthenticationSucceeded(Miuiface result) {
            BiometricLoggerImpl.d("MiuiFaceUnlockModule.onAuthenticationSucceeded: " + result);
            if (listener != null) {
        ...
        public void onAuthenticationFailed() {
            BiometricLoggerImpl.d("MiuiFaceUnlockModule.onAuthenticationFailed: ");
            if (listener != null) {
