...
public class AndroidFaceUnlockModule extends AbstractBiometricModule {
    private FaceAuthenticationManager manager = null;
    ...
    public AndroidFaceUnlockModule(BiometricInitListener listener) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            try {
                manager = (FaceAuthenticationManager) getContext().getSystemService("face");
            } catch (Throwable ignore) {
                manager = null;
            }
        }
    ...
    public void authenticate(final CancellationSignal cancellationSignal,
        ...
        if (manager != null) {
            try {
                ...
                final FaceAuthenticationManager.AuthenticationCallback callback =
    ...
    class AuthCallback extends FaceAuthenticationManager.AuthenticationCallback {
