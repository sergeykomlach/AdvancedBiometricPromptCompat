...
enum class BiometricMethod(id: Int, biometricType: BiometricType) {
    CUSTOM_UNDEFINED(10000, BiometricType.BIOMETRIC_ANY),
    CUSTOM_FINGERPRINT(10001, BiometricType.BIOMETRIC_FINGERPRINT),
    CUSTOM_FACE(10002, BiometricType.BIOMETRIC_FACE),
    CUSTOM_IRIS(10003, BiometricType.BIOMETRIC_IRIS),
    CUSTOM_VOICE(10004, BiometricType.BIOMETRIC_VOICE),
    CUSTOM_PALMPRINT(10005, BiometricType.BIOMETRIC_PALMPRINT),
    CUSTOM_HEARTRATE(10006, BiometricType.BIOMETRIC_HEARTRATE),
    CUSTOM_BEHAVIOR(10007, BiometricType.BIOMETRIC_BEHAVIOR),
