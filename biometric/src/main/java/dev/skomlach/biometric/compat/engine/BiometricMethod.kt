...
enum class BiometricMethod(val id: Int, val biometricType: BiometricType) {
    ...
    FINGERPRINT_FLYME(103, BiometricType.BIOMETRIC_FINGERPRINT), //http://open-wiki.flyme.cn/index.php?title=%E6%8C%87%E7%BA%B9%E8%AF%86%E5%88%ABAPI
    FINGERPRINT_SOTERAPI(104,BiometricType.BIOMETRIC_FINGERPRINT),

    FACE_ANDROIDAPI(201,BiometricType.BIOMETRIC_FACE),
    FACE_SAMSUNG(202, BiometricType.BIOMETRIC_FACE), //https://github.com/fonix232/SCoverRE/blob/2374565740e4c7bfc653b3f05bd9be519e722e32/Reversed/framework/com/samsung/android/bio/face/SemBioFaceManager.java
    FACE_OPPO(203, BiometricType.BIOMETRIC_FACE),
    FACE_HUAWEI3D(204, BiometricType.BIOMETRIC_FACE),//https://developer.huawei.com/consumer/en/doc/development/Security-References/overview-0000001051748079
    ...
    IRIS_SAMSUNG(301, BiometricType.BIOMETRIC_IRIS),  //https://github.com/fonix232/SCoverRE/blob/2374565740e4c7bfc653b3f05bd9be519e722e32/Reversed/framework/com/samsung/android/camera/iris/SemIrisManager.java
