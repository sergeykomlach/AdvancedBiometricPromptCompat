...
public class API23FingerprintModule extends AbstractBiometricModule {
    ...
    public API23FingerprintModule(BiometricInitListener listener) {
        ...
        if (listener != null) {
            listener
                    .initFinished(BiometricMethod.FINGERPRINT_API23, API23FingerprintModule.this);
        }
    }
    ...
    public void authenticate(final CancellationSignal cancellationSignal,
        ...
        for (BiometricMethod method : BiometricMethod.values()) {
            if (method.getId() == tag()) {
                BiometricLoggerImpl.d("API23BiometricModule.authenticate - " + method.toString());
            }
        }
        ...
        if (manager != null) {
            try {
                ...
                BiometricLoggerImpl.e(e, "API23BiometricModule: authenticate failed unexpectedly");
            }
        }
    ...
    class AuthCallback extends FingerprintManager.AuthenticationCallback {
        ...
        public void onAuthenticationError(int errMsgId, CharSequence errString) {
            BiometricLoggerImpl.d("API23BiometricModule.onAuthenticationError: " + CodeToString.getErrorCode(errMsgId) + "-" + errString);
        ...
        public void onAuthenticationHelp(int helpMsgId, CharSequence helpString) {
            BiometricLoggerImpl.d("API23BiometricModule.onAuthenticationHelp: " + CodeToString.getHelpCode(helpMsgId) + "-" + helpString);
            if (listener != null) {
        ...
        public void onAuthenticationSucceeded(FingerprintManager.AuthenticationResult result) {
            BiometricLoggerImpl.d("API23BiometricModule.onAuthenticationSucceeded: " + result);
            if (listener != null) {
        ...
        public void onAuthenticationFailed() {
            BiometricLoggerImpl.d("API23BiometricModule.onAuthenticationFailed: ");
            if (listener != null) {
