...
import dev.skomlach.biometric.compat.monetsupport.extensions.getAttributeColor
import dev.skomlach.biometric.compat.monetsupport.extensions.isDarkMode
import dev.skomlach.biometric.compat.monetsupport.extensions.isSameAs
...
import dev.skomlach.biometric.compat.monetsupport.utils.factory.ColorSchemeFactory
import dev.skomlach.biometric.compat.monetsupport.utils.theme.ColorScheme
import dev.skomlach.biometric.compat.monetsupport.utils.theme.DynamicColorScheme
import dev.skomlach.biometric.compat.monetsupport.utils.theme.MaterialYouTargets
import dev.skomlach.biometric.compat.monetsupport.utils.theme.SystemColorScheme
...
class MonetCompat private constructor(context: Context) {
    ...
    fun getAccentColor(context: Context, darkMode: Boolean? = null): Int {
        return if (darkMode ?: context.isDarkMode) {
            ...
            monetColors?.accent1?.get(700)?.toArgb() ?: ContextCompat.getColor(
                context,
                defaultAccentColor!!
            )
        }
