...
import com.kieronquinn.monetcompat_light.extensions.getAttributeColor
import com.kieronquinn.monetcompat_light.extensions.isDarkMode
import com.kieronquinn.monetcompat_light.extensions.isSameAs
...
import dev.kdrag0n.monet_light.colors.Srgb
import dev.kdrag0n.monet_light.factory.ColorSchemeFactory
import dev.kdrag0n.monet_light.theme.*
    ...
    companion object {
        ...
        fun enablePaletteCompat() {
            try {
                ...
                androidx.palette.graphics.Palette.from(
                    Bitmap.createBitmap(
                        1,
                        1,
